...
function drop(event) {
  ...
  var ham = new Audio('ArrangeTheLetters/audio/ham.mp3');
  ...
  if(isCorrectMatching) {
    ...
    if(draggableElementData == "h") {
      setTimeout(function() {h.play();}, 1500);
        ...
        setTimeout(function() {m.play();}, 1800);
        setTimeout(function() {ham.play();}, 4900);
        setTimeout(function() {JAM();}, 6200);
      }
  } 
  else {
